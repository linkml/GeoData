# Contributing to geodata

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
geodata. These guidelines are not strict rules.
...
The geodata team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the geodata technical leads
...
[issues]: https://github.com/example-org/geodata/issues/
[pulls]: https://github.com/example-org/geodata/pulls/
